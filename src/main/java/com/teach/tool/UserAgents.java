...
public class UserAgents {
    ...
    static {
        ...
        userAgentList.add("Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; QQDownload 732; .NET4.0C; .NET4.0E) ");
        userAgentList
    ...
    public static String getRandomUserAgent() {
        int max = userAgentList.size();
        return userAgentList.get(new Random().nextInt(max));
    }
